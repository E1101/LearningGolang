...
func New(d time.Duration) *Runner {
	return &Runner{
		...
		// The tasks field is not explicitly initialized,
		// since the zero value for this field is a nil slice.
	}
}
...
func (r *Runner) Start() error {
	...
	// !! blocks waiting for one of two events to occur
	select {
...
func (r *Runner) gotInterrupt() bool {
	select {
		...
		// !! default case turns the attempt to receive on the
		// interrupt channel into a nonblocking call
		default:
			return false
	}
}
